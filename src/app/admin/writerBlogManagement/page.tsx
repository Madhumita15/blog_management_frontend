        ...
        <div className="flex flex-row justify-between  text-white">
          ...
          <div>
            <Button
              ...
              className={
                "cursor-pointer bg-pink-700 text-white hover:bg-slate-900 hover:text-pink-200 hover:border-2 hover:border-white border-2 border-black  px-3 py-1 font-bold rounded-md"
              }
            >
              + Add Blog
            </Button>
